...
var GlassContainer = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: `relative ${className} ${active ? "active" : ""} ${Boolean(onClick) ? "cursor-pointer" : ""}`, style: { ...styleWithoutTransform, overflow: "hidden", borderRadius: `${cornerRadius}px` }, onClick, children: [
