...
var GlassContainer = forwardRef(
  ({
    ...
    return /* @__PURE__ */ jsxs("div", { ref, className: `relative ${className} ${active ? "active" : ""} ${Boolean(onClick) ? "cursor-pointer" : ""}`, style: { ...style, backdropFilter: blurValue, WebkitBackdropFilter: blurValue, overflow: "hidden", borderRadius: `${cornerRadius}px` }, onClick, children: [
