...
var GlassContainer = (0, import_react.forwardRef)(
  ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref, className: `relative ${className} ${active ? "active" : ""} ${Boolean(onClick) ? "cursor-pointer" : ""}`, style: { ...style, backdropFilter: blurValue, WebkitBackdropFilter: blurValue, overflow: "hidden", borderRadius: `${cornerRadius}px` }, onClick, children: [
...
function LiquidGlass({
  ...
  const baseTranslate = disableAutoCenter ? `translate(${elasticTranslation.x}px, ${elasticTranslation.y}px)` : `translate(calc(-50% + ${elasticTranslation.x}px), calc(-50% + ${elasticTranslation.y}px))`;
